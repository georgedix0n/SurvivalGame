...
void AWeapon::SetInstigatorFromCharacter(ASurvivalCharacter* Character)
{
...
{
	int32 ClipDelta = FMath::Min(WeaponConfig.AmmoPerClip - CurrentAmmoInClip, GetCurrentAmmo() - CurrentAmmoInClip);
...
bool AWeapon::CanReload() const
{
	...
	bool bGotAmmo = (CurrentAmmoInClip < WeaponConfig.AmmoPerClip) && (GetCurrentAmmo() - CurrentAmmoInClip > 0);
...
void AWeapon::SetPawnOwner(ASurvivalCharacter* SurvivalCharacter)
{
	...
	{
		SetInstigatorFromCharacter(SurvivalCharacter);
